...
{{--</div>--}}
{!! Form::model($motocycle,['method'=>'PATCH','action'=>['\App\Http\Controllers\MotocyclesController@update',$motocycle->id]]) !!}
@include('motocycles.form',['submitbuttontext'=>"編輯車種資料"])
{!! Form::close() !!}
@endsection
